//! Convert dB amplitude levels into 0.0..1.0 values for waveform rendering.

/// Normalize dB levels to 0.0..1.0 for display.
///
/// Input: negative dB values (e.g., -35.0 quiet, -3.0 loud).
