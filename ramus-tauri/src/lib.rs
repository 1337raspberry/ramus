...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::library::get_filtered_random_album,
            ...
            commands::crates::estimate_crate,
            ...
            commands::downloads::estimate_playlist,
            commands::downloads::download_bookmark,
            commands::downloads::estimate_bookmark,
